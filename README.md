...
- **18.05.2022**
  - Додано налаштування `--processes` для роботи у декілька дочірніх процессів (рекомендовано до вкористання при наявності 4+ CPU).
...
### CLI
    ...
    optional arguments:
      ...
      --processes 1          Number of subprocess to spawn. Feature is disabled when set to 1 (default)
